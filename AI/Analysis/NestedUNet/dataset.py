...
class Dataset(torch.utils.data.Dataset):
    def __init__(self, img_ids: list, img_dir: str, mask_dir: str, img_ext: str, mask_ext: str, num_classes: int, transform: torch.Tensor=None):
        """

        Args:
            img_ids (list): Image ids.
            img_dir (str): Image file directory.
            mask_dir (str): Mask file directory.
