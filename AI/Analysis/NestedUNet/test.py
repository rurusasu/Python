...
def parse_args():
    ...
    parser.add_argument('--name',
                                    default="dsb2018_96_NestedUNet_woDS",
                                    help='model name')
...
def main():
    ...
    results_dir_path = cfg.UNET_RESULTS_DIR


    with open(os.path.join(cfg.UNET_MODELS_DIR, args['name'], "config.yml")) as f:
    ...
    model.load_state_dict(torch.load(os.path.join(cfg.UNET_MODELS_DIR, config['name'], "model.pth")))
