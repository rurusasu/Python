...
parser.add_argument("--cfg_file", type=str, default="./config/linemod_train.json")
parser.add_argument("--linemod_cls", type=str, default="ape")

parser.add_argument(
    "--use_gt_mask", action="store_true", dest="use_gt_mask", default=False
)
parser.add_argument(
    "--test_model", action="store_true", dest="test_model", default=False
)
parser.add_argument(
    "--test_sequence", action="store_true", dest="test_sequence", default=False
)
parser.add_argument(
    "--use_test_set", action="store_true", dest="use_test_set", default=False
)
parser.add_argument(
    "--use_uncertainty_pnp",
    action="store_true",
    dest="use_uncertainty_pnp",
    default=False,
)

parser.add_argument(
    "--visualize_bbox", action="store_true", dest="visualize_bbox", default=False
)
...
parser.add_argument(
    "--visual_occluded", dest="visual_occluded", action="store_true", default=False
)
parser.add_argument(
    "--visual_special", dest="visual_special", action="store_true", default=False
)
parser.add_argument(
    "--visual_mask_out", dest="visual_mask_out", action="store_true", default=False
)
...
parser.add_argument(
    "--visualize_hyp_pts", dest="visualize_hyp_pts", action="store_true",
)
...
parser.add_argument(
    "--no-visualize_hyp_pts", dest="visualize_hyp_pts", action="store_false"
)
parser.add_argument("--no-visualize_mask", dest="visualize_mask", action="store_false")
parser.add_argument(
    "--no-visualize_points", dest="visualize_points", action="store_false"
)
