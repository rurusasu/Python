...
# TrainingData_1
#################
cfg.ANGLE_TRAININGDATA1_DIR = os.path.join(cfg.ANGLE_DETECTION_DIR, "TrainingData_1")
...
# TrainingData_2
#################
cfg.ANGLE_TRAININGDATA2_DIR = os.path.join(cfg.ANGLE_DETECTION_DIR, "TrainingData_2")
