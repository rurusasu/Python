                ...
                dobot.GetDeviceSN(new DataReceiveListener() {
                    ...
                    public void OnReceive() {
                        ...
                        switch (ReturnCode) {
                            ...
                            case CmdState.Normal:
                                String sn = dobot.ReadDeviceSN();
                                display.setText(sn);
                                break;

                            case CmdState.TimeOut:
                                Toast.makeText(MainActivity.this, "return timeout", Toast.LENGTH_SHORT).show();
                                break;
                            default:
                                break;
                        }
                    ...
                    public void OnReceive() {
                        ...
                        switch (ReturnCode) {
                            ...
                            case CmdState.Normal:
                                ...
                                float z = pose.getZ();
                                float r = pose.getR();
                                Log.e("TAG-----", "X=" + x + "  Y=" + y + "  Z=" + z + "  R=" + r);
                                display.setText("X=" + x + "  Y=" + y + "  Z=" + z + "  R=" + r);
                                break;
